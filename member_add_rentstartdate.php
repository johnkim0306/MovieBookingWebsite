...
while($row = mysqli_fetch_array($result4))
  ...
  echo "<td><a onClick= \"return confirm('Do you want to book this movie?')\" href='member_view_renting_payment.php?job=book&amp;RentingAllInfo= " . $row["TheatreID"] . ";" . $row["Date"] . "; " . $row["StartTime"] . ";" . $row["EndTime"] . "'>Book</a></td>";
