...
while($row = mysqli_fetch_array($result2))
  ...
  echo "<td><a onClick= \"return confirm('Do you want to Select this renting?')\" href='member_view_renting_payment.php?job=delete&amp;ServiceID= " . $row['ServiceID'] . "'>Select</a></td>";
